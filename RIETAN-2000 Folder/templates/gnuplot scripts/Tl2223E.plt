...
if (iout == 2) \
   ...
   set size 2.0, 1.25; \
   set output 'Tl2223E.eps'

xmin = 12 # Minimum for the x-axis
xmax = 155 # Maximum for the x-axis
ymin = -500 # Minimum for the y-axis
ymax = 2740 # Maximum for the y-axis
offset_delta = -200 # Offset of the difference curve along the y axis
len_bar = 0.01 * (ymax - ymin) # Length of bars for peak positions
y_phase1 = 100 # y coordinate of bars for phase No. 1
set ytics 0, 500, 3000 # Start, increment, and end values of tics for the  y axis
...
if (iout == 0) plot [*:*] [*:*] \
   'Tl2223E.pat'using 1:3 notitle with lines linetype 11 linewidth 1, \
...
if (iout == 2) plot [xmin:xmax] [ymin:ymax] \
   'Tl2223E.pat' using 1:3 notitle with lines linetype 5 linewidth 1, \
