...
if (iout == 2) \
   ...
   set size 2.0, 1.25; \
   set output 'CimetidineE.eps'

xmin = 8 # Minimum for the x-axis
xmax = 85 # Maximum for the x-axis
ymin = -40000 # Minimum for the y-axis
ymax = 190000 # Maximum for the y-axis
offset_delta = -25000 # Offset of the difference curve along the y axis
len_bar = 0.01 * (ymax - ymin) # Length of bars for peak positions
y_phase1 = -7000 # y coordinate of bars for phase No. 1
set ytics 0, 50000, 200000 # Start, increment, and end values of tics for the  y axis
...
#set ticscale 1 1 # Same length for major and minor tic marks
...
if (iout == 0) plot [*:*] [*:*] \
   'CimetidineE.pat'using 1:3 notitle with lines linetype 11 linewidth 1, \
...
if (iout == 2) plot [xmin:xmax] [ymin:ymax] \
   'CimetidineE.pat' using 1:3 notitle with lines linetype 5 linewidth 1, \
